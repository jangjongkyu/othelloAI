 ...
 * 
 */
public class AlphaOStrongMonteCarlo implements OthelloAI {
	private int player;
	private Block[][] board;
	private int cnt;
	private int lastCnt;
	...
	// private Integer max;
	public AlphaOStrongMonteCarlo(int player, Block[][] board, int cnt, int lastCnt, int level, GameView gameView) {
	...
	class MultiThinking extends Thread {
		...
		public double getAlphaProb() {
			...
			System.out.println("[ "+originBlock.getPosValue()+" ] alpha : "+this.alpha + " , prob : "+prob + " , 백분율 : "+ monteCarloSearch.winProb.getProbability());
			return res;
		}
