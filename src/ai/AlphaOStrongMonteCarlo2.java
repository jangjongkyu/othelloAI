 ...
 * 
 */
public class AlphaOStrongMonteCarlo2 implements OthelloAI {
	private int player;
	private Block[][] board;
	private int cnt;
	private int lastCnt;
	...
	// private Integer max;
	public AlphaOStrongMonteCarlo2(int player, Block[][] board, int cnt, int lastCnt, int level, GameView gameView) {
	...
	class MultiThinking extends Thread {
		...
		public double getAlphaProb() {
			...
			double res = (double)this.alpha + (monteCarloSearch.getAlphaAvg()/(double)3);
