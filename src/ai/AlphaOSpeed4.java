...
import ai.AlphaODwarfSpeed3.MultiThinking;
import game.Block;
import util.WinProb;

public class AlphaOSpeed4 implements OthelloAI {
	private int player;
	private Block[][] board;
	private int cnt;
	private int lastCnt;
	...
	//private Integer max;
	public AlphaOSpeed4(int player, Block[][] board, int cnt, int lastCnt, int level) {
		this.player = player;
		this.board = board;
		this.cnt = cnt;
