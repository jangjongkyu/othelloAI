...
public class AlphaOStrongSpeed4_2 implements OthelloAI {
	private int player;
	private Block[][] board;
	private int cnt;
	private int lastCnt;
	...
	// private Integer max;
	public AlphaOStrongSpeed4_2(int player, Block[][] board, int cnt, int lastCnt, int level, GameView gameView) {
