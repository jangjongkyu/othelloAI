...
public class AlphaOStrongDwarf implements OthelloAI {
	private int player;
	private Block[][] board;
	private int cnt;
	private int lastCnt;
	...
	// private Integer max;
	public AlphaOStrongDwarf(int player, Block[][] board, int cnt, int lastCnt, int level, GameView gameView) {
