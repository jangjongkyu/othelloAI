 ...
 * 
 */
public class AlphaOStrongSpeed5_180421_Origin implements OthelloAI {
	private int player;
	private Block[][] board;
	private int cnt;
	private int lastCnt;
	...
	// private Integer max;
	public AlphaOStrongSpeed5_180421_Origin(int player, Block[][] board, int cnt, int lastCnt, int level, GameView gameView) {
